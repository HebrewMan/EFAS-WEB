...
export default function Items({ items, assetsType }: any) {
                            ...
                            <div key={index} className="cursor-pointer list pl-28px pr-30px flex-between-center pb-10px"
                                ...
                                <div className='flex-between-center w-410px pr-22px'>
                                    ...
                                    <div className='w-310px'>
                                        <p className='text-15px pl-10px color-#AA41FD'>{item.metadata.name}  &nbsp;&nbsp;Lv. {index + 1}</p>
                                ...
                                <span className='w-215px text-15px text-white pl-22px pr-22px'>#{item.id}</span>
