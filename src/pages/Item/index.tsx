    ...
    return (
        <>
            <div className='wh-full flex-center'>
                {/* <Login /> */}
                {/* <Claim /> */}
                <div className="w-900px relative overflow-hidden " style={{ border: '1px solid #304755', background: 'rgba(255,255,255,0.05)', borderRadius: '5px' }}>
                    ...
                    <Row gutter={40} className='m-auto pl-60px pr-26px mt-20px'>
                        <Col xs={{ order: 1, span: 24 }} sm={{ order: 2, span: 24 }} md={{ span: 12 }} lg={{ span: 12 }}>
                            <p className='text-25px color-#AA41FD flex-between-center '>
                                <span>FAMAS ASSAULT RIFLE</span><span>Lv.27</span>
                            </p>
                            <p className='flex-between-center mt-14px color-#ffffff'>
                                <span className='text-18px'>CERTIFICATE</span><span className='text-16px'><mark className='color-#A7BAFC' style={{ background: 'none' }}>DURABILITY :</mark>  3500/3500</span>
                            </p>
                            <p className='mt-8px flex-y-center text-20px color-#AA41FD'>
                    ...
                    <Row gutter={40} className='m-auto pl-60px pr-26px mt-15px color-#A7BAFC text-14px'>
                        <Col xs={{ order: 1, span: 24 }} sm={{ order: 2, span: 24 }} md={{ span: 12 }} lg={{ span: 12 }}>
                            ...
                            <p className='h-30px flex-between-center' style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
                        ...
                        <Col xs={{ order: 1, span: 24 }} sm={{ order: 2, span: 24 }} md={{ span: 12 }} lg={{ span: 12 }} className='color-#07E520 text-14px'>
                            ...
                            <p className='line-height-20px color-#3A91F8' style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
                            ...
                            <p className='line-height-20px color-#EF9F3D' style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
                    ...
                    <div className='flex-between-center mt-20px pl-60px pr-26px pt-20px pb-20px' style={{ background: 'rgba(5,7,14,0.32)' }}>
                        <p></p>
                        <Button type="primary" style={btnStyle} className='w-110px h-32px color-text' onClick={() => openSellModal()}>{btnText}</Button>
                    </div>
